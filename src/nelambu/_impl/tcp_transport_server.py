...
import psutil
from nelambu._impl.session_state import SessionState
...
from nelambu._impl.transport_server import RequestHandler
...
class TcpTransportServerImpl(ss.ThreadingMixIn, ss.TCPServer):
    ...
    def __init__(
        ...
        self.session_store: dict[int, SessionState] = {}
...
class TcpHandler(ss.BaseRequestHandler):
    ...
    def handle(self) -> None:
        ...
        try:
            ...
            while request_nr != 0:
                ...
                if should_process:
                    response = server.transport_server._handler.handle_request(request)  # noqa: SLF001
    ...
    def _start_session(self) -> int:
        ...
        if req_session_id == 0:
            ...
            _logger.info(
                "The TCP network connection for session %s was lost", req_session_id
            )
    ...
    def finish(self) -> None:
        ...
        server._handler.close()  # noqa: SLF001
